<template>
  ...
  >
    ...
    <UModal v-model:open="showDecisionModal">
      <UButton icon="i-lucide-gavel" label="Make Decision" size="lg" />
        ...
        <div class="space-y-4">
          <div>
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400">
              Client:
              <span class="font-medium">{{ task.client_detail?.name }}</span>
            </p>
          </div>
    ...
    <UModal v-model:open="showForwardModal">
      <UButton icon="i-lucide-forward" label="Forward" size="lg" />
