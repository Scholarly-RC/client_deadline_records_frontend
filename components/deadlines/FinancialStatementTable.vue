...
// Stores
const financialStatementTableStore = useFinancialStatementTableStore();
...
const handleSetPage = async (page) => {
  await financialStatementTableStore.setPage(page);
};

// Reactive variables
const { financialStatements, pagination, isLoading } = storeToRefs(
  financialStatementTableStore
);

onMounted(async () => {
  await financialStatementTableStore.getAllFinancialStatements();
});
</script>
