...
import { hrImplementationSchema } from "~/schema/hrImplementation.schema";
...
const { showModal } = storeToRefs(hrImplementationModalStore);
...
const validationSchema = toTypedSchema(hrImplementationSchema);
...
const onSubmit = handleSubmit(async (values) => {
  ...
  try {
    ...
    toast.add({
      title: "Success",
      description: "HR Implementation task has been created successfully.",
      color: "success",
    ...
    resetForm();
    hrImplementationModalStore.close();
    emit("clearAddDeadlineForm");
  } catch (error) {
    console.error("Error creating HR Implementation task:", error);
    toast.add({
...
<template>
  <UModal
    ...
    title="HR Implementation Task Details - Step 2 of 2"
