...
// Stores
const miscellaneousTableStore = useMiscellaneousTableStore();
...
const handleSetPage = async (page) => {
  await miscellaneousTableStore.setPage(page);
};

// Reactive variables
const { miscellaneousTasks, pagination, isLoading } = storeToRefs(
  miscellaneousTableStore
);

onMounted(async () => {
  await miscellaneousTableStore.getAllMiscellaneousTasks();
});
</script>
